...
import 'package:finalyear/pages/profile.dart';
...
class Donate extends StatefulWidget {
  final String urlval;
  Donate({Key key, @required this.urlval}) : super(key: key);
  @override
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Center(
                child: new Text('Enter the book details',
                    style: TextStyle(
                        color: Colors.teal,
          ...
          Container(
            ...
            child: new TextFormField(
              ...
              decoration: InputDecoration(
                  focusColor: Colors.white,
                  hoverColor: Colors.white,
                  hintText: 'Mobile Number to approach',
                  hintStyle: TextStyle(
                    color: Colors.white,
                  ),
                  disabledBorder: InputBorder.none,
           ...
           Container(
            ...
            child: new TextFormField(
              ...
              validator: (val) => validator.postalCode(val) ? 'Enter Valid Postal code' : null,
            ),
          ),
          ...
          SizedBox(
            ...
            onPressed: () async{
               if (_formKey.currentState.validate()) {
                 await addbooks(nameController.text, emailController.text,passwordController.text, mobileController.text, widget.urlval,postalController.text);
                Navigator.push(
    context,
